...
KAFIN_ICON = dict(
    view_box=(24, 24),
    d="M4 4 L11 12 L4 20 L6.5 20 L13.5 12 L6.5 4 Z M13 17 L20.5 17 L20.5 19.5 L13 19.5 Z",
)
...
BADGES = [
    ...
    dict(key="kafin",    label="Kafin",    url="https://kafin.netlify.app",                  icon=KAFIN_ICON, mono=None),
]
